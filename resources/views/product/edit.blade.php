                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" name="price" value="{{ $product->price }}" class="form-control @error('price') is-invalid @enderror"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3"
                                        placeholder="Introduzca la descripción del producto">{{ $product->description }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
            ...
            <div class="col-md-2">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Activo</label>
                            <input class="form-control @error('active') is-invalid @enderror" type="checkbox" name="active" {{ $product->active ? 'checked' : '' }}>
                            @error('active')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
